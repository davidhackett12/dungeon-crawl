 ...
 */
final class Version20190210195914 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles VARCHAR(180) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
